...
In Chapter~\ref{model}, we present the \emph{reactive component} model for reactive systems.
...
The reactive component model is a viable model for designing and implementing reactive systems.
...
%% Another assumption we made when designing the language and run-time was the use of garbage collection.
