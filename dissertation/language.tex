...
In the reactive component paradigm, the semantics of active statements and ports provide strong guarantees when composing and checking for illegal composition becomes the responsibility of the runtime environment (Section~\ref{sound_composition}).
