...
Figure~\ref{process} shows the \verb+Process+ component.
...
The approach take by the languages cited thus far is to demonstrate freedom from data races through the type system exclusively.
...
As described in Section~\ref{execution} and Section~\ref{scheduler}, the scheduler has the responsibility of scheduling transactions in a way that avoid data races between transactions.
